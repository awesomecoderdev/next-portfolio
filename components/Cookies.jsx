...
export default function Cookies() {
	...
	return (
		<>
			{!cookie ? (
				<section className="fixed max-w-md p-4 z-[9999] mx-auto bg-white border border-gray-200 dark:bg-gray-800 left-12 bottom-16 dark:border-gray-700 rounded-2xl">
